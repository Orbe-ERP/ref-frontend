...
const slides = [
  {
    id: "1",
    image: require("assets/images/Report/relatorio.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/index.png"),
    subtitle: "Na tela inicial, clique no botão 'Relatórios'.",
  },
  {
    id: "3",
    image: require("assets/images/Report/relatorio1.png"),
    subtitle: "Nesta tela, você vê um resumo diário das vendas. Use os filtros para visualizar períodos diferentes.",
  },
];

const ReportOnboardingScreen = () => {
...
export default ReportOnboardingScreen;
