...
const slides = [
  {
    id: "1",
    image: require("assets/images/Inicial/tela-inicial.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/Inicial/tela-inicial1.png"),
    subtitle: "",
  },
  {
    id: "3",
    image: require("assets/images/Inicial/tela-inicial2.png"),
    subtitle: "Quando o restaurante estiver selecionado, a tela aparecerá assim.",
  },
];

const InicialOnboardingScreen = () => {
...
export default InicialOnboardingScreen;
