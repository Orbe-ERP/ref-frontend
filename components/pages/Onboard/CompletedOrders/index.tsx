...
const slides = [
  {
    id: "1",
    image: require("assets/images/CompletedOrders/comandas-finalizadas.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/config.png"),
    subtitle: "Na tela de configurações, acesse 'Comandas Finalizadas'.",
  },
  {
    id: "3",
    image: require("assets/images/CompletedOrders/comandas-finalizadas1.png"),
    subtitle: "Aqui você verá suas comandas finalizadas.",
  },
  {
    id: "4",
    image: require("assets/images/CompletedOrders/comandas-finalizadas2.png"),
    subtitle: "",
  },
];

const CompletedOrdersOnboardingScreen = () => {
  ...
  return (
    <Container>
        <Stack.Screen
          options={{
            title: "Ajuda - Comandas finalizadas",
...
export default CompletedOrdersOnboardingScreen;
