...
const slides = [
  {
    id: "1",
    image: require("assets/images/Tables/mesas.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/Tables/mesas1.png"),
    subtitle: "Para começar, localize o ícone de garfo e faca no menu inferior da tela inicial e clique nele.",
  },
  {
    id: "3",
    image: require("assets/images/Tables/mesas2.png"),
    subtitle: "Clique em 'Criar Mesa', adicione o nome e clique em 'Criar Mesa'.",
  },
];

const TablesOnboardingScreen = () => {
...
export default TablesOnboardingScreen;
