...
const slides = [
  {
    id: "1",
    image: require("assets/images/Kitchen/cozinha.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/index.png"),
    subtitle: "Na tela inicial, clique no botão 'Cozinha'.",
  },
  {
    id: "3",
    image: require("assets/images/Kitchen/cozinha1.png"),
    subtitle: "Nesta tela, você acompanha os pedidos de cada mesa e atualiza o status conforme o andamento.",
  },
  {
    id: "4",
    image: require("assets/images/Kitchen/cozinha1.png"),
    subtitle: "Para diferenciar os tipos de cozinha, cada uma é exibida na cor que você definiu durante o cadastro.",
  },
];
...
export default KitchenOnboardingScreen;
