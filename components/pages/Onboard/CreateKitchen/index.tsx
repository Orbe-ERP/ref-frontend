...
const slides = [
  {
    id: "1",
    image: require("assets/images/CreateKitchen/cozinhas.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/config.png"),
    subtitle: "Na tela de configurações, acesse 'Gerenciar Cozinhas'.",
  },
  {
    id: "3",
    image: require("assets/images/CreateKitchen/cozinhas1.png"),
    subtitle: "Clique para criar uma nova cozinha.",
  },
  {
    id: "4",
    image: require("assets/images/CreateKitchen/cozinhas2.png"),
...
const CreateKitchenOnboardingScreen = () => {
...
export default CreateKitchenOnboardingScreen;
