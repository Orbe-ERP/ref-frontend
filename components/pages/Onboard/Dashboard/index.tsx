...
const slides = [
  {
    id: "1",
    image: require("assets/images/Dashboard/dashboard.png"),
    subtitle: "",
  },
  {
    id: "2",
    image: require("assets/images/index.png"),
    subtitle: "Na tela inicial, clique no botão 'Dashboard Completo'.",
  },
  {
    id: "3",
    image: require("assets/images/Dashboard/dashboard1.png"),
    subtitle: "Nesta tela, você encontra o resumo dos pratos mais vendidos do dia e pode filtrar os resultados por semana ou mês.",
  },
];

const DashboardOnboardingScreen = () => {
...
export default DashboardOnboardingScreen;
