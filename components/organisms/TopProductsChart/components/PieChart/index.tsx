    ...
    return (
      ...
      >
        ...
        <Text style={[styles.emptySubtext, { color: theme.colors.text.muted }]}>
          {type === "category"
            ? "Configure categorias no sistema"
            : "Complete vendas para ver a análise"}
        </Text>
      </View>
    );
  }
      ...
      <View style={styles.chartWithLegend}>
        <View style={styles.chartWrapper}>
          ...
          <View style={styles.centerLabel}>
            <Text
              style={[styles.totalValue, { color: theme.colors.text.primary }]}
            >
              R$ {totalValue.toFixed(0)}
            </Text>
            <Text
              style={[styles.totalLabel, { color: theme.colors.text.muted }]}
            >
              {valueLabel}
            </Text>
          </View>
                ...
                <View style={styles.legendTextContainer}>
                  ...
                  {segment.productCount > 0 && (
                    ...
                    >
                      ...
                      {segment.productCount === 1 ? "produto" : "produtos"}
                    </Text>
                  )}
                </View>
              </View>
