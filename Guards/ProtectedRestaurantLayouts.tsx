...
export default function ProtectedRestaurantLayout({ children }: { children?: React.ReactNode }) {
  ...
  const needsAuthRedirect = !authLoading && !user?.hasAuthenticatedUser && pathname !== "/login";
    ...
    return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        ...
        <Text style={{ marginTop: 12 }}>
          {needsAuthRedirect ? "Redirecionando para login..." : "Redirecionando..."}
        </Text>
      </View>
    );
  }
